...
public class KindergartenGardenTest {
    ...
    public void singleStudent() {
        ...
        String plants = "RC\nGG";
        List<Plant> expected =
                Arrays.asList(Plant.RADISHES, Plant.CLOVER, Plant.GRASS, Plant.GRASS);
    ...
    public void singleStudent2() {
        ...
        String plants = "VC\nRC";
        List<Plant> expected =
                Arrays.asList(Plant.VIOLETS, Plant.CLOVER, Plant.RADISHES, Plant.CLOVER);
    ...
    public void twoStudents() {
        ...
        String plants = "VVCG\nVVRC";
        List<Plant> expected =
                Arrays.asList(Plant.CLOVER, Plant.GRASS, Plant.RADISHES, Plant.CLOVER);
    ...
    public void oneGardenSecondStudent() {
        ...
        List<Plant> expected =
                Arrays.asList(Plant.CLOVER, Plant.CLOVER, Plant.CLOVER, Plant.CLOVER);
    ...
    public void fullGardenFirstStudent() {
        ...
        List<Plant> expected =
                Arrays.asList(Plant.VIOLETS, Plant.RADISHES, Plant.VIOLETS, Plant.RADISHES);
    ...
    public void fullGardenLastStudent() {
        ...
        String plants = "VRCGVVRVCGGCCGVRGCVCGCGV\nVRCCCGCRRGVCGCRVVCVGCGCV";
        List<Plant> expected =
                Arrays.asList(Plant.GRASS, Plant.VIOLETS, Plant.CLOVER, Plant.VIOLETS);
